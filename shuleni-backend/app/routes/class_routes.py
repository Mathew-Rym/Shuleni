...
class_bp.route('/', methods=['POST'])(
    jwt_required()(roles_required('admin', 'teacher')(school_required(create_class)))
)
...
class_bp.route('/<int:class_id>', methods=['PUT'])(
    jwt_required()(roles_required('admin', 'teacher')(school_required(update_class)))
)
...
class_bp.route('/<int:class_id>/students', methods=['POST'])(
    jwt_required()(roles_required('admin', 'teacher')(school_required(enroll_student)))
)
